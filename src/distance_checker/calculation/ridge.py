...
class CreatingRidge:
    ...
    def creating_lines(self,
        ...
        point_b1 = Point(1500,
                         (math.tan(math.radians(-right_girder_angle))) * 1500)
        point_b2 = Point(-1500,
                         (math.tan(math.radians(-left_girder_angle))) * 1500)
        ...
        line_a1b1_flange = line_a1b1.parallel_offset(
            right_t_flange_girder, "right")

        # drawings thickness top flange left side
        line_a1b2_flange = line_a1b2.parallel_offset(left_t_flange_girder,
                                                     "left")
        ...
        point_a3 = Point(line_a3b3.coords[0])
        point_b3 = Point(line_a3b3.coords[1])

        point_a4 = Point(line_a4b4.coords[0])
        ...
        line_a1_end_point_for_ridge = LineString(
            [point_a1, end_point_for_ridge])
        ...
        line_a9a11 = LineString([point_a9, point_a11[0]])

        # line right side from mounting right side
        line_a9a12 = LineString([point_a10, point_a12[0]])
        ...
        line_a13a14 = LineString([point_a13, point_a14[0]])
        ...
        looking_value_mounting_from_left = point_a1.distance(
            mounting_from_left)
        ...
        line_a16a17 = LineString([point_a16, point_a17[0]])
        ...
        looking_value_mounting_from_right = point_a1.distance(
            mounting_from_right)
        ...
        return ([
                ...
                [looking_value_mounting_from_left,
                 looking_value_mounting_from_right]
        )
